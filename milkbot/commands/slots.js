...
module.exports = {
  ...
  async execute(message) {
    ...
    balances[userId] = Math.min(1_000_000_000, (balances[userId] || 0) + actualWinnings);
    ...
    setTimeout(() => {
      ...
      if (isJackpot) {
        ...
        spinMsg.edit(
          ...
          `${resultLine}\n` +
          `*(net: ${netStr} milk bucks${multiplier > 1 ? ' — 🔥 1.5x hot streak' : ''}${balances[userId] >= 1_000_000_000 ? ' — 🏦 balance cap reached' : ''})*`
        );
      }
